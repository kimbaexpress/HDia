        ...
        <div id="main-content" class="flex-1 flex flex-col h-full overflow-hidden">
            ...
            <div class="flex-1 p-10 overflow-auto">
                <div class="block p-6 rounded-lg shadow-lg bg-white max-h-full overflow-auto">
                    <!-- Modificar la etiqueta del formulario -->
                    <form id="myForm" action="generate_doc.php" method="post" enctype="multipart/form-data" onsubmit="return checkSubmit();">

                        <input type="hidden" name="form_token" value="<?php echo $form_token; ?>">
                        <div>
                            <p>FORMULARIO ONCOHEMATOLOGIA
                            </p>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control block w-full px-4 py-2 text-gray-700 bg-white border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="fecha" name="fecha" placeholder="dd/mm/aaaa" required>
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="form-group">
                                <label for="edad_pte" class="form-label inline-block mb-2 text-gray-700">Edad del paciente:</label>
                                <input type="text" class="form-control block w-full px-4 py-2 text-gray-700 bg-white border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="edad_pte" name="edad_pte" placeholder="Edad" required>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-group mb-6">
                            <label for="infusionDosis" class="form-label inline-block mb-2 text-gray-700">INFUSION DOSIS:</label>


                            <textarea class="form-control block w-full px-4 py-2 text-gray-700 bg-white border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="inf_dosis" name="inf_dosis" placeholder="Infusion Dosis" maxlength="2000" required></textarea>
                        </div>

                        <p id="charCountInf">0/2000</p>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="form-group">
                                <label for="habitacion" class="form-label inline-block mb-2 text-gray-700">Habitación:</label>
                                <input type="text" class="form-control block w-full px-4 py-2 text-gray-700 bg-white border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="habitacion_pte" name="habitacion_pte" placeholder="Número de habitación">
                            </div>
                            <div class="form-group">
                                <label for="sector" class="form-label inline-block mb-2 text-gray-700">Sector:</label>
                                <input type="text" class="form-control block w-full px-4 py-2 text-gray-700 bg-white border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="sector_pte" name="sector_pte" placeholder="Sector">
                            </div>
                        </div>
                        ...
                        <!-- CHECK BOXS  -->
                        <div class="mb-6 mt-4">
                            <span class="text-gray-700">¿Solicita medicación?</span>
                            <div class="mt-2">
                                <label class="inline-flex items-center">
                                    <input type="radio" class="form-radio" name="solicita_medicacion" id="solicita_medicacion_si" value="Si">
                                    <span class="ml-2">Si</span>
                                </label>
                                <label class="inline-flex items-center ml-6">
                                    <input type="radio" class="form-radio" name="solicita_medicacion" id="solicita_medicacion_no" value="No">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control block w-full px-4 py-2 text-gray-700 bg-white border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="ev_pte" name="ev_pte" placeholder="Evaluación medica" maxlength="1200"></textarea>
                            <p id="charCount">0/1200</p>
                        ...
                        <div class="text-center pt-2">
                            ...
                            <!-- Añadir este bloque antes del botón "Generar Archivo" -->
                            <div class="form-group mb-6">
                                <label for="pdf_files" class="form-label inline-block mb-2 text-gray-700">Adjuntar PDF(s):</label>
                                <input type="file" class="form-control block w-full" id="pdf_files" name="pdf_files[]" accept="application/pdf" multiple>
                            </div>
