...
try {
    ...
    $docx_template_path = "../../pages/formularios/forms_conteiner/editable_forms/{$form_id}_sacarato.docx"; // {$form_id}_oncohematologia.docx, {$form_id}_quimioterapia.docx
    ...
    $pdf_path = "../../pages/formularios/forms_conteiner/{$form_id}_sacarato.pdf"; // {$form_id}_oncohematologia.pdf, {$form_id}_quimioterapia.pdf
